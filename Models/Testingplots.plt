...
set style line 7 lc rgb '#0A0A0A' lt 1 ps 2 lw 6 dt 1 
...
set terminal pngcairo size 1280,450 
set output "../Report/Testing-4-22-2020.png"
...
unset xrange
set title "Daily tests"
set ylabel "tests"
set xtics nomirror
plot 'CT-COVID19.tsv' u 1:8 w points ls 1
set title "Tests as multiple of baseline"
set ylabel "multiple of baseline"
set key top left
plot 'CT-COVID19.tsv' u 1:9 w points ls 1 t "data", '' u 1:10 w steps ls 2 t "interpolating"
unset multiplot
unset label
